    ...
    <div class="row">
        <div class="col-md-12">
			<div class="row div-margin">
				<div class="col-md-6 col-xs-6 div-padding">
					<a class="" href="{{ backpack_url('clientes') }}">
				...
				<div class="col-md-6 col-xs-6 div-padding">
					<a class="" href="{{ backpack_url('productos') }}">
						<div class="div-item-menu">
				...
				<div class="col-md-6 col-xs-6 div-padding">
					<a class="" href="{{ backpack_url('pedidos') }}" id="link-pedido">
						<div class="div-item-menu">
				...
				@if(Backpack_auth()->user()->tipo_user == 1)
					<div class="col-md-6 col-xs-6 div-padding">
						<a class="" href="{{ backpack_url('user') }}">
							<div class="div-item-menu">
				...
				@endif
				<div class="col-md-6 col-xs-6 div-padding">
					<a class="" href="{{ url(config('backpack.base.route_prefix', 'admin').'/logout') }}">
						<div class="div-item-menu">
