...
<div class="form-group col-md-12 checklist_dependency_secondary_rows"  data-entity ="{{ $field['field_unique_name'] }}" @include('crud::inc.field_wrapper_attributes')>
    ...
    <?php
      ...
      if( isset($id) && $id ){
		...
		$tituloPrimeraColumna = isset( $request_field_array['nombre_entidad'] ) ? $request_field_array['nombre_entidad'] : 'Modelo';
    ?>
    <script>
    ...
    @foreach ($primary_dependency['model']::all() as $connected_entity_entry)
        <div class="form-group col-md-{{ isset($primary_dependency['number_columns']) ? intval(12/$primary_dependency['number_columns']) : '4'}}">
            <div class="checkbox">
                <label>
                    <input type="checkbox"
